...
export default function Statistics({ navigation }: any): React.JSX.Element {
	...
	const fetchData = async () => {
		try {
			...
			const intakes = await dbm.selectIntakeByDate(db, {year: currentDate.getFullYear(), month: currentDate.getMonth(), day: currentDate.getDate()});
			let total = 0;
	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.goalContainer}>
				...
				<View style={styles.goalRectangleBox}>
